...
public class OldDiagnosis extends Fragment{

	Bundle b;
	Button chiefComplaint, historyOfIllness, datePicker, medicalHistory;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_old_diagnosis,
				container, false);
		
		datePicker = (Button) rootView.findViewById(id.button_datepicker);
		...
		datePicker.setOnClickListener(myListener);
